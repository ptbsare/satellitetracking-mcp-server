...
import { formatSatelliteData } from './tool-utils.js'; // We'll need to extract common functions
...
export async function searchSatellitesByNameTool(apiClient, args) {
    try {
        const { query } = args;
        ...
        throw new McpError(ErrorCode.InternalError, `Error searching for satellites by name: ${error.message}`);
    }
}
//# sourceMappingURL=satellite-search-by-name.js.map