...
export async function predictVisualPassesTool(apiClient, args) {
    try {
        ...
        if (min_visibility !== undefined && (min_visibility < 0 || min_visibility > 600)) {
            throw new McpError(ErrorCode.InvalidParams, 'Invalid min_visibility. Must be between 0 and 600 seconds.');
        }
        const params = {
            noradId: norad_id,
            observer_lat,
        ...
        throw new McpError(ErrorCode.InternalError, `Error predicting satellite passes: ${error.message}`);
    }
}
...
//# sourceMappingURL=visual-passes.js.map