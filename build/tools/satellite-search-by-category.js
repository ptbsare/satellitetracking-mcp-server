...
export async function searchSatellitesByCategoryTool(apiClient, args) {
    try {
        ...
        throw new McpError(ErrorCode.InternalError, `Error searching for satellites by category: ${error.message}`);
    }
}
//# sourceMappingURL=satellite-search-by-category.js.map