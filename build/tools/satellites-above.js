...
export async function getSatellitesAboveTool(apiClient, args) {
    try {
        ...
        if (search_radius !== undefined && (search_radius < 0 || search_radius > 90)) {
            throw new McpError(ErrorCode.InvalidParams, 'Invalid search_radius. Must be between 0 and 90 degrees.');
        }
        // Validate category_id
        if (category_id !== undefined && (!Number.isInteger(category_id) || category_id < 0 || category_id > 30)) {
            throw new McpError(ErrorCode.InvalidParams, 'Invalid category_id. Must be an integer between 0 and 30.');
        }
        const params = {
            observer_lat,
            observer_lng,
        ...
        throw new McpError(ErrorCode.InternalError, `Error retrieving satellites above: ${error.message}`);
    }
}
function formatSatelliteData(satellite) {
    return {
...
//# sourceMappingURL=satellites-above.js.map